                ...
                <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh'}}>
                    ...
                    >
                        ...
                        <div>
                            <div className="mt-6 border-t border-gray-100">
                                <dl className="divide-y divide-gray-100">
                                    ...
                                    <div className="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt className="text-sm font-medium leading-6 text-gray-900">Объект обращения
                                        </dt>
                                                ...
                                                <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                                    <div className="flex w-0 flex-1 items-center">
                                                        ...
                                                        <div className="ml-4 flex min-w-0 flex-1 gap-2">
                                                            <span
                                                                className="truncate font-medium">ВашаУжаснаяДверь.jpg</span>
                        ...
                        <Flex gap="small" wrap>
                            ...
                            <Button type="primary">Закрыть обращение</Button>
                            <Button type="link" onClick={handleButtonClick}>Дефект №17 от 17.04.2024 "Дверь"</Button>
                            <Button type="link">Дефект №18 от 17.04.2024 "Окно"</Button>
                        </Flex>
