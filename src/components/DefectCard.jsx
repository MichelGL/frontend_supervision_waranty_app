...
function DefectCard() {
    ...
    const defectName = "Дверь"; // Пример наименования нарушения
                ...
                <div style={{
                    ...
                    >
                        ...
                        <div>
                            <div className="mt-6 border-t border-gray-100">
                                <dl className="divide-y divide-gray-100">
                                    ...
                                    {/* Отказ подрядчика */}
                                    <div className="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt className="text-sm font-medium leading-6 text-gray-900">Отказ подрядчика
                                        </dt>
                                    ...
                                    <div className="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt className="text-sm font-medium leading-6 text-gray-900">Название объекта
                                            строительства
                                        </dt>
                                        <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{constructionObjectName}</dd>
                                    </div>
                                    <div className="px-2 py-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt className="text-sm font-medium leading-6 text-gray-900">Адрес объекта
                                            строительства
                                        </dt>
                                                ...
                                                <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                                    <div className="flex w-0 flex-1 items-center">
                                                        ...
                                                        <div className="ml-4 flex min-w-0 flex-1 gap-2">
                                                            <span
                                                                className="truncate font-medium">Предписание.pdf</span>
                        ...
                        <Flex gap="small" wrap>
                            ...
                            <Button type="primary" onClick={handleButtonClick}>Создать задачу</Button>
